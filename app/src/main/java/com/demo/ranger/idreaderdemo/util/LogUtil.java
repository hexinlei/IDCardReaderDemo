...
public class LogUtil {
    ...
    private static void writeLogtoFile(String mylogtype, String tag, String text) {// 新建或打开日志文件
        ...
        File directoryLog = new File(IDCardReaderConstans.MYLOG_PATH_SDCARD_DIR_LOG);
        if (!directoryLog.exists()){
            directoryLog.mkdirs();
        }

        //创建文件
        File file = new File(IDCardReaderConstans.MYLOG_PATH_SDCARD_DIR_LOG, needWriteFiel
                + MYLOGFILEName);
    ...
    public static void delFile() {// 删除日志文件
        ...
        File file = new File(IDCardReaderConstans.MYLOG_PATH_SDCARD_DIR, needDelFiel + MYLOGFILEName);
        if (file.exists()) {
            file.delete();
        }
    }
